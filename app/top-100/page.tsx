...
export const metadata: Metadata = {
  ...
  description: 'The definitive ranking of the best restaurants in Madison, Wisconsin. Honest reviews and cheese curd ratings.',
};
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400">
            The definitive ranking based on food quality, atmosphere, service, and value
          </p>
        ...
        {restaurants.length > 0 ? (
          <div className="space-y-4">
            {restaurants.map((restaurant, index) => (
              ...
              >
                {/* Ranking Number */}
                <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-lg bg-curd-100 dark:bg-curd-900">
          ...
          <div className="rounded-lg border-2 border-dashed border-zinc-300 p-12 text-center dark:border-zinc-700">
            <div className="mx-auto max-w-md">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">
                I&apos;m working my way through Madison&apos;s incredible restaurant scene. 
                Check back soon as I add new reviews every week!
              </p>
        ...
        <div className="mt-16 rounded-lg bg-white p-8 dark:bg-zinc-900">
          ...
          <div className="prose prose-zinc dark:prose-invert">
            <p className="text-zinc-700 dark:text-zinc-300">
              Rankings are based on the overall rating, which is calculated from five 
            ...
            <p className="mt-4 text-zinc-700 dark:text-zinc-300">
              All reviews are based on anonymous visits and paid meals. No sponsored 
              content, no free meals—just honest opinions.
            </p>
          </div>
        </div>
      </div>
